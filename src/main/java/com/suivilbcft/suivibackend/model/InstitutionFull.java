...
public class InstitutionFull {
    ...
    // Link to utilisateur (user) - Utiliser une relation plus simple
    @ManyToOne(fetch = FetchType.LAZY) 
    @JoinColumn(name = "id_utilisateur", nullable = false, referencedColumnName = "id_utilisateur")
    private Utilisateur utilisateur;

    // Relationships to questionnaire responses (normalized) - Lazy fetch pour éviter les chargements inutiles
